        ...
        server: ServerSettings {
            ...
            transport: vec![
                ServerTransports::WebTransport {
                    local_port: 5000,
                    certificate: WebTransportCertificateSettings::AutoSelfSigned(vec!["localhost".to_string()]),
                    // FromFile {
                    //     cert: "../certificates/ssl-cert-snakeoil.pem".to_string(),
                    //     key: "../certificates/ssl-cert-snakeoil.key".to_string(),
                    // },
                },
